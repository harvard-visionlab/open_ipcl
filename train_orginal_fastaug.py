...
#
# CUDA_VISIBLE_DEVICES=2 python step_by_step_imagenet_instance06_replicate_stack_fastaug.py
# CUDA_VISIBLE_DEVICES=1 python step_by_step_imagenet_instance06_replicate_stack_fastaug.py --data /n/holyscratch01/alvarez_lab/Lab/datasets/imagenet-256
#
#!/usr/bin/env python
# coding: utf-8
...
args = Dict({
    ...
    "out_dir": "./results/step_by_step_imagenet_instance06_replicate_stack_fastaug/ipcl_alpha_stack_fastaug_alexnet_gn_n5_lr03_pct40_t07_div1000_e100_bs128_bm20_rep1",
    "memory_device": 'gpu',
...
from dataloaders.standard_samples import get_standard_imagenet as get_dataloaders

trainloader, recomputeloader, testloader = get_dataloaders(args)

if args.max_prefetch: trainloader = PrefetchDataLoader(trainloader, max_prefetch=args.max_prefetch)
if args.max_prefetch: testloader = PrefetchDataLoader(testloader, max_prefetch=args.max_prefetch)
...
if args.max_prefetch: recomputeloader = PrefetchDataLoader(recomputeloader, max_prefetch=args.max_prefetch)
